...
private:
    ...
    double angle =
        std::atan2(target_y_ - current_y, target_x_ - current_x) - pose->theta;//pose->theta:当前朝向
...
private:
    rclcpp::Subscription<turtlesim::msg::Pose>::SharedPtr pose_subscription_;//发布者智能指针
    rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr velocity_publisher_;//订阅者智能共享指针
